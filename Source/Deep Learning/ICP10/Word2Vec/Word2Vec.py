...
#observed the model for embedding_size from 150 to 1000
# Dimension of embedding vector
embedding_size = 150

#observed the model for skip-window from 1 to 10
...
#observed model for num_steps from 5000 to 2,00,000
num_steps = 5000

with tf.Session() as sess:
    sess.run(init)
    writer = tf.summary.FileWriter('./graphs/nlp', sess.graph)
    average_loss = 0
